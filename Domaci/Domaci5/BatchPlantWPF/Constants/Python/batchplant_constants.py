...
class MethodIds(Enum):
    ...
    BatchPlantType_changeMotorSpeed = "nsu=http://opcfoundation.org/BatchPlant;i=440"
    ...
    BatchPlant1_changeMotorSpeed = "nsu=http://opcfoundation.org/BatchPlant;i=441"
...
class VariableIds(Enum):
    ...
    BatchPlantType_changeMotorSpeed_InputArguments = "nsu=http://opcfoundation.org/BatchPlant;i=442"
    ...
    BatchPlant1_changeMotorSpeed_InputArguments = "nsu=http://opcfoundation.org/BatchPlant;i=443"
